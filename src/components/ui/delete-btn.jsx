...
function Deletebtn({ onClick, className}) {
  return (
    <button
      onClick={onClick}
      className={`del-btn ${className.toString()} group relative flex h-14 w-14 flex-col items-center justify-center overflow-hidden rounded-md  bg-red-400 hover:bg-red-600`}
    >
      <svg
